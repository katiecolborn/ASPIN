...
source("C:/Users/ASRock/OneDrive - The University of Colorado Denver/Katie Project/2021_1109/UTI/Generate_statistics_source_function_1109_UTI.R")

start8 <- Sys.time()
trial1 <- Generate_statistics_res_UTI(column_sums=c(500,600),fdr_col=c(0.225,0.25))
end8 <- Sys.time()
...
write.csv(trial8$result,file = "C:/Users/ASRock/OneDrive - The University of Colorado Denver/Katie Project/2021_1109/UTI/res/UTI_PheCode.csv")