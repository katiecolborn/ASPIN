...
Generate_statistics_res_UTI <- function(nfolds=10,train_date_end="2017-03-01",column_sums=c(5,10,15,20),fdr_col=c(0,1,0.12,0.15,0.2),offset=1,parallelcores ="max",data_type="Rdata",
                                    ...
                                    fileName ="final_data_labpanel_SSIUTIPNEU",save_res=TRUE,save_dir="C:/Users/ASRock/OneDrive - The University of Colorado Denver/Katie Project/2021_1109/UTI/res/")
{
